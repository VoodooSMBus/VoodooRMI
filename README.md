...
* Likely compatible if you run `dmesg` and find a message along the lines of `"Your trackpad x says it can support a different bus."` and it's a synaptics trackpad.
